...
HD_PWD='F:/Xilinx/Projects/ip_repo/chacha_customip_trial_1.0/chacha_customip_trial_v1_0_project/chacha_customip_trial_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chacha_customip_trial_v1_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source chacha_customip_trial_v1_0.tcl
