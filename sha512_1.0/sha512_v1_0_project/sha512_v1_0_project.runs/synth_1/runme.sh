...
HD_PWD='F:/Xilinx/Projects/ip_repo/sha512_1.0/sha512_v1_0_project/sha512_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sha512_v1_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source sha512_v1_0.tcl
