...
HD_PWD='F:/Xilinx/Projects/ip_repo/chacha_customip_trial_1.0/chacha_customip_trial_v1_0_project/chacha_customip_trial_v1_0_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log chacha_customip_trial_v1_0.vdi -applog -m64 -messageDb vivado.pb -mode batch -source chacha_customip_trial_v1_0.tcl -notrace
