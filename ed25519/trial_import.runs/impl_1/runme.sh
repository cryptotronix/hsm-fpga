...
HD_PWD='F:/Xilinx/Projects/trial_import/trial_import.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ed_keygen_trial_v1_0.vdi -applog -m64 -messageDb vivado.pb -mode batch -source ed_keygen_trial_v1_0.tcl -notrace
