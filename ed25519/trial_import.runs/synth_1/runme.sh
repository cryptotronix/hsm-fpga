...
HD_PWD='F:/Xilinx/Projects/trial_import/trial_import.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ed_keygen_trial_v1_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ed_keygen_trial_v1_0.tcl
