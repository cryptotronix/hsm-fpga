proc create_ipi_design { offsetfile design_name } {
	...
	set sha256_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:sha256:1.0 sha256_0]
	...
	connect_bd_intf_net [get_bd_intf_pins master_0/M_AXI_LITE] [get_bd_intf_pins sha256_0/S00_AXI]

	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins master_0/M_AXI_LITE_ACLK] [get_bd_pins sha256_0/S00_AXI_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins master_0/M_AXI_LITE_ARESETN] [get_bd_pins sha256_0/S00_AXI_ARESETN]
	...
	set offset_file "${bd_path}/sha256_v1_0_tb_include.vh"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:sha256:1.0]]]]
set test_bench_file ${ip_path}/example_designs/bfm_design/sha256_v1_0_tb.v
